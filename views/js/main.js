...
---------------------------- */
 ...
 /*---------------------
    price slider
--------------------- */
var mi = $("#slider-range").attr('data-slider-min');
var ma = $("#slider-range").attr('data-slider-max')-1;
$( "#slider-range" ).slider({
      range: true,
      min: mi - 1,
      max: ma + 1,
      ...
      $("#sea_p").attr('href',root+'&min='+ui.values[0]+'&max='+ui.values[1]);
  },
  });
...
---------------------------- */
  ...
  --------------------- */
    ...
    },
    {
      ...
      source: Productos,
      templates: {
        header: '<h3 class="league-name">Productos</h3>',
        empty: [
          '<h4 class="league-name">Productos</h4>',
          '<div class="empty-message">',
            '--Ningun producto--',
          '</div>'
        ].join('\n'),
        suggestion: Handlebars.compile('<div><div class="col-xs-3"><a href="{{link}}"><img src="{{image}}" alt="{{value}}" height="42"/></a></div><div class="col-xs-9"><p><a href="{{link}}" style="color:#000;text-transform: capitalize;">{{value}}</a></p><p>{{price}}</p></div></div>')
      }
    },
    {
      name: 'brand',
      ...
      source: Marcas,
      templates: {
        header: '<h3 class="league-name">Marcas</h3>',
        empty: [
          '<h4 class="league-name">Marcas</h4>',
          '<div class="empty-message">',
            '--Ningua marca--',
          '</div>'
        ].join('\n'),
        suggestion: Handlebars.compile('<div style="text-transform: capitalize;">{{value}}</div>')
